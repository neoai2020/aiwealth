            ...
            <div className={cn("p-4 rounded-xl border transition-all", step >= 2 ? "bg-primary/5 border-primary/20" : "bg-white/[0.02] border-white/5 opacity-50")}>
              ...
              <div className="ml-10 space-y-2">
                <p className="text-xs text-gray-400 leading-relaxed">
                  Go to <a href="https://www.digistore24-app.com/app/en/affiliate/account/marketplace/all" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">digistore24.com/marketplace</a>, search for the product name, and click <strong className="text-white">&quot;Promote Now&quot;</strong> to get your unique promo link.
                </p>
                <a href="https://www.digistore24-app.com/app/en/affiliate/account/marketplace/all" target="_blank" rel="noopener noreferrer" onClick={() => setStep(Math.max(step, 3))} className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-xs font-bold text-gray-300 hover:text-white hover:bg-white/10 transition-all">
